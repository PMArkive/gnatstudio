      ...
      begin
         ...
         loop
            ...
            then
               ...
               --  and slocs reported to the callback mix a stale line with
               --  a column computed on a later one. The line breaks located
            ...
            case Casing is
               ...
               when Upper | Lower | Mixed | Smart_Mixed  =>
                  ...
                  if To_Lower (Buffer (Prec .. Current)) /= "some"
                    ...
                    and then
                      not (Buffer (Prec .. Current) = "f"
                           and then Current + 1 in Buffer'Range
